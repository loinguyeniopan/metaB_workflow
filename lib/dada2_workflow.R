...
asv_table <- file.path(output_dir, "ENI_ASV_table.csv") # Output file for ASV table
stats_file <- file.path(output_dir, "ENI_filter_stats.csv") # Output file for filtering statistics
repseq_file <- file.path(output_dir, "ENI_representative_sequences.fasta") # Output file for representative sequences
